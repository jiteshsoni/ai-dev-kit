---
name: scaling-spark-streaming-jobs
description: Benchmark results and patterns for running multiple Spark streaming jobs on a single cluster cost-effectively. Use when running multiple concurrent streams, optimizing cluster utilization, or designing multi-tenant streaming architectures.
---
