---
name: spark-streaming-master-class-kafka-to-delta
description: Complete guide to streaming data from Kafka to Delta Lake using Spark Structured Streaming, with checkpoint internals and production patterns. Use when ingesting Kafka data into Delta tables, setting up production streaming pipelines, or understanding checkpoint mechanics for Kafka sources.
---
