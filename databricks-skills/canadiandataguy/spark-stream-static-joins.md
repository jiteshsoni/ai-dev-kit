...
description: Master stream-static joins for real-time data enrichment with Delta tables, including left join patterns and broadcast optimization. Use when enriching streaming data with dimension tables, implementing IoT device enrichment, or joining streams with slowly-changing reference data.
---
