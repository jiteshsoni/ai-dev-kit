...
description: Build a personal knowledge agent using Obsidian for notes and Cursor for AI-powered retrieval, all running locally. Use when organizing personal notes, creating a searchable knowledge base from your content, or building a local RAG system without cloud dependencies.
---
