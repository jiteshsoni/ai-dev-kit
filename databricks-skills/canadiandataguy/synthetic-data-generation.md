...
description: Generate terabytes of test data quickly and cheaply using Spark for load testing and development. Use when creating test datasets, load testing streaming applications, generating realistic IoT or e-commerce data, or building development environments.
---
