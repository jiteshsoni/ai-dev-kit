---
name: introduction-to-foreachbatch
description: Use ForEachBatch to write to any target, perform custom logic, and migrate from batch to streaming incrementally. Use when writing to non-Delta sinks, implementing custom processing logic per microbatch, or migrating batch jobs to streaming without rewriting transformation code.
---
