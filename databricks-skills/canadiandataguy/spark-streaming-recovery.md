---
name: spark-streaming-recovery
description: Deep dive into Spark Streaming failure recovery mechanisms, exactly-once semantics, and checkpoint-based fault tolerance. Use when debugging stream failures, understanding recovery behavior, verifying exactly-once guarantees, or implementing fault-tolerant streaming pipelines.
---
