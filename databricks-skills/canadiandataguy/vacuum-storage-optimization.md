---
name: vacuum-storage-optimization
description: Use Delta Lake VACUUM to manage storage costs with Full, Light, and Inventory-based cleanup strategies. Use when storage costs are high, managing Delta table retention policies, or optimizing time travel storage overhead.
---
